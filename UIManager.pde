...
public static class UIManager {
  ...
  private void onMouseDown() {
    ...
    for (PointerArea area: this.areas) area.mouseDown(this.applet.mouseX, this.applet.mouseY, button);
  }
  
  private void onMouseUp() {
    int button = Mouse.translate(this.applet.mouseButton);
    for (PointerArea area: this.areas) area.mouseUp(this.applet.mouseX, this.applet.mouseY, button);
  }
  ...
  private void drawWidgets() {
    ...
    this.applet.rect(0, this.canvasHeight, this.canvasWidth, this.windowHeight - this.canvasHeight);
...
public static class PointerArea {
  ...
  private static final Component PLACEHOLDER_COMPONENT = new Frame();
  private static java.awt.event.MouseEvent createMouseEvent(int x, int y) {
    return new java.awt.event.MouseEvent(PLACEHOLDER_COMPONENT, 0, 0L, 0, x, y, 0, false);
  }
  private static java.awt.event.MouseEvent createMouseEvent(int x, int y, int button) {
    return new java.awt.event.MouseEvent(PLACEHOLDER_COMPONENT, 0, 0L, 0, x, y, 0, false, button);
  }
}